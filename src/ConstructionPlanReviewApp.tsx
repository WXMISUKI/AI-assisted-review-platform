...
export interface ConstructionPlanReviewAppProps {
  session: Session;
  themeMode: ThemeMode;
  onToggleTheme: () => void;
...
export function ConstructionPlanReviewApp({
  session,
  themeMode,
  onToggleTheme,
  onBackToProducts,
  onLogout,
}: ConstructionPlanReviewAppProps) {
    ...
    <div className="platform-shell">
      <aside className="shell-sidebar">
        ...
        <div className="shell-sidebar-foot">
          ...
          <button type="button" className="theme-toggle" onClick={onBackToProducts}>
            <ArrowLeft size={16} />
            返回业务门户
          </button>
