# opening-condition-review-state-normalization Specification

## Purpose
TBD - created by archiving change opening-condition-review-state-normalization-and-rerun-guidance. Update Purpose after archive.
## Requirements
