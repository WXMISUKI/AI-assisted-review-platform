# ai-gateway-routing-readiness Specification

## Purpose
Define platform-safe readiness validation for MaxKB AI gateway `app_code` routing configuration, including OpenAI-compatible and MCP protocol enablement, route policy, rate-limit policy, and secret redaction.
## Requirements
