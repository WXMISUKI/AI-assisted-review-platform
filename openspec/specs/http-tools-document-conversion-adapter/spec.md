# http-tools-document-conversion-adapter Specification

## Purpose
TBD - created by archiving change opening-condition-http-tools-document-export. Update Purpose after archive.
## Requirements
